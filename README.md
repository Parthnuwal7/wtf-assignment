...
4. DeepSeek produces a structured evidence summary with findings, limitations, evidence level, and source citations.
...
- Eight retrieved sources, with a capped source brief sent to DeepSeek.
...
- Defensive DeepSeek JSON handling: JSON mode, bounded retry, JSON repair, and Zod validation.
...
- The first turn retrieves up to eight sources, then sends a stable source brief capped at 24,000 characters to DeepSeek.
